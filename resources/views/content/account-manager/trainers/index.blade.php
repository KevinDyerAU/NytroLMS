...
@section('content')
    <section id="trainers-datatable">
    {{$dataTable->table()}}
    <!-- Modal to add new record -->
        @if($hasModal?? false)
            <div class="modal modal-slide-in fade" id="modals-slide-in">
                <div class="modal-dialog sidebar-sm">
                    <form method='POST' action='{{ route('account_manager.trainers.store') }}'
                        ...
                        <div class="modal-body flex-grow-1">
                            @include('content.account-manager.trainers.modal-body')
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        $(function() {
            ...
            @endcan
                ...
                view: '{{ route('account_manager.trainers.show',':id') }}',
                edit: '{{ route('account_manager.trainers.edit',':id') }}',
            }, true);
