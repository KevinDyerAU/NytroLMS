...
<div class="row g-1 g-md-2 p-1" data-client-validate>
    {{-- Existing Student Select (combobox) - Only show for leaders --}}
    @if (!empty($all_students) && auth()->user()->isLeader())
                ...
                <select class="form-select select2" id="existing_student" name="existing_student"
                    ...
                    @foreach ($all_students as $s)
                        <option value="{{ $s->id }}"
                            ...
                            {{ $s->first_name }} {{ $s->last_name }} ({{ $s->email }}){{ ($s->detail && $s->detail->status === 'INACTIVE') ? ' - INACTIVE' : '' }}
                        </option>
                    @endforeach
                </select>
            </div>
    ...
    <div class="col-lg-4 col-md-6 col-12">
        <div class="mb-1 mb-0 mb-md-1">
            ...
            <input type="text" class="form-control @error('preferred_name') is-invalid @enderror" id="preferred_name"
                name="preferred_name" placeholder="Preferred Name" value="{{ old('preferred_name') }}"
    ...
    <div class="col-lg-4 col-md-6 col-12">
        <div class="mb-1 mb-0 mb-md-1">
            ...
            <input type="text" class="form-control @error('preferred_language') is-invalid @enderror"
                ...
                value="{{ old('preferred_language') }}" aria-describedby="preferred_language_help">
    ...
    <div class="col-lg-4 col-md-6 col-12">
        <div class="mb-1 mb-0 mb-md-1">
            ...
            <input type="text" class="form-control phone-input @error('phone') is-invalid @enderror" id="phone"
                name="phone" placeholder="Phone Number" value="{{ old('phone') }}" required inputmode="numeric"
                autocomplete="tel" aria-describedby="phone_help">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="mb-1 mb-0 mb-md-1">
                ...
                <input type="text" class="form-control autocomplete-address @error('address') is-invalid @enderror"
                    ...
                    autocomplete="street-address" aria-describedby="address_help">
                @error('address')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
    ...
    <div class="col-lg-4 col-md-6 col-12">
        <div class="mb-1 mb-0 mb-md-1">
            ...
            <input type="text" class="form-control @error('purchase_order') is-invalid @enderror"
                id="purchase_order" name="purchase_order" placeholder="Purchase Order No"
                value="{{ old('purchase_order') }}" required list="purchase_order_options"
                aria-describedby="purchase_order_help">
        ...
        <div class="mb-1 mb-0 mb-md-1">
            ...
            <select data-placeholder="Choose learning schedule..." class="select2 form-select"
                ...
                @foreach ($schedule as $item)
                    <option value="{{ $item }}" {{ $item == old('schedule') ? 'selected' : '' }}>
                        {{ \Str::title($item) }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mb-1 mb-0 mb-md-1">
            ...
            <select data-placeholder="Choose employment service..." class="select2 form-select"
                ...
                @foreach ($employment_service as $item)
                    <option value="{{ $item }}" {{ $item == old('employment_service') ? 'selected' : '' }}>
                        {{ $item }}
                    </option>
                @endforeach
            </select>
                ...
                <select data-placeholder="Choose leader..." class="select2 form-select"
                    ...
                    @if (!empty($leaders))
                        @foreach ($leaders as $leader)
                            <option value="{{ $leader->id }}" {{ $leader->id == old('leaders') ? 'selected' : '' }}>
                ...
                <select data-placeholder="Select a Trainer..." class="select2 form-select"
                    ...
                    @if (!empty($trainers))
                        @foreach ($trainers as $trainer)
                            <option value="{{ $trainer->id }}" {{ $trainer->id == old('trainers') ? 'selected' : '' }}>
    ...
    @else
        <div class="col-lg-2 col-md-6 col-12">
            <div class="mb-1 mb-0 mb-md-1">
                ...
                <input type="date" class="form-control date-picker @error('course_start_at') is-invalid @enderror"
        ...
        <div class="col-lg-2 col-md-6 col-12">
            <div class="mb-1 mb-0 mb-md-1">
                ...
                <input type="date" class="form-control date-picker @error('course_ends_at') is-invalid @enderror"
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-1 gap-md-2">
        <div class="d-flex gap-1 gap-md-2">
            ...
            <button type="submit" id="submit-form"
                ...
                <span class="d-inline">Create</span>
