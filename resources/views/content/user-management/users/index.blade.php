...
@section('content')
    <section id="users-datatable">
    {{$dataTable->table()}}
    <!-- Modal to add new record -->
        @if($hasModal?? false)
            <div class="modal modal-slide-in fade" id="modals-slide-in">
                <div class="modal-dialog sidebar-sm">
                    <form method='POST' action='{{ route('user_management.users.store') }}'
                        ...
                        <div class="modal-body flex-grow-1">
                            @include('content.user-management.users.modal-body')
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        $(function() {
            ...
            @endcan
                ...
                view: '{{ route('user_management.users.show',':id') }}',
                edit: '{{ route('user_management.users.edit',':id') }}'
            }, true);
