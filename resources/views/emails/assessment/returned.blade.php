                            ...
                            <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%"
                                ...
                                <tr>
                                    <td class="sm-px-24"
                                        ...
                                        <p style='line-height: 1.5rem;'> Your assessment has been returned for resubmission.
                                            <br />
                                            Please review the feedback and comments provided by your trainer to make the necessary improvements before resubmitting.
                                            <br />
                                            <a href="{{ route('frontend.lms.quizzes.show', $attempt->quiz ) }}"
                                               class="btn btn-primary" title="{{ $attempt->quiz->title }}">Re-attempt
                                                Quiz</a>
                                        </p>
                                        <p style='line-height: 1.5rem;'>
                                            <a href="{{ route('frontend.lms.quizzes.attempt', [$attempt->quiz, $attempt] ) }}"
                                               class="btn btn-primary" title="{{ $attempt->quiz->title }}">View Result for Last Attempt</a>
                                        </p>
