...
<body
    ...
    <div style="display: none;">A request to reset password was received from your {{ env('APP_NAME') }} Account</div>
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                {{ \Str::title($notifiable->name) }}</p>
                                            <p style="margin: 0 0 24px;">
                                                A request to reset password was received from your
                                                <span style="font-weight: 600;">{{ env('APP_NAME') }}</span> Account -
                                                <a href="mailto:{{ $notifiable->email }}" class="hover-underline"
                                                    style="--text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">{{ $notifiable->email }}</a>
                                                from the IP - <span
                                                    style="font-weight: 600;">{{ request()->ip() }}</span> .
                                            </p>
                                            ...
                                            <p style="margin: 24px 0;">
                                                Otherwise, you can copy and paste following link in your browser to
                                                reset your password:
                                                <br />
                                                <a href="{{ $url }}"
                                                    title="Password Reset">{{ $url }}</a>
                                            </p>
                                            <p style="margin: 24px 0;">
                                            ...
                                            <p style="margin: 0 0 16px;">
                                                ...
                                                <a href="mailto:{{ config('settings.site.institute_email', 'admin@keyinstitute.com.au') }}"
