...
<div style="display: none;">Student Application Completed</div>
                    ...
                    <tr>
                        <td align="center" class="sm-px-24" style="font-family: 'Montserrat',Arial,sans-serif;">
                            <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%"
                                ...
                                <tr>
                                    <td class="sm-px-24"
                                        style="--bg-opacity: 1; background-color: #ffffff; background-color: rgba(255, 255, 255, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 24px; text-align: left; --text-opacity: 1; color: #626262; color: rgba(98, 98, 98, var(--text-opacity));"
                                        bgcolor="rgba(255, 255, 255, var(--bg-opacity))" align="left">
                                        <p style="font-weight: 600; font-size: 18px; margin-bottom: 0; color: orange; text-align: center;">
                                            Student Application Completed</p>
                                        <p style="margin: 0 0 24px; color: orange; text-align: center;">
                                            This is a notice to confirm that
                                            <span style="font-weight: 600;">{{ $student->name }}</span> has successfully
                                            been enrolled into the Anaconda Academy.
                                        </p>
...
//                                                \Log::debug('New Student to Leader', ['$enrolments' => $enrolments,'type' => gettype($enrolments),'basic'=> $enrolments['basic'],'schedule' => $enrolments['basic']['schedule']]);
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <table style="font-family: 'Montserrat',Arial,sans-serif;"
                                                           cellpadding="0" cellspacing="0" role="presentation">
                                                        <tr>
                                                            <td colspan="3">Registration Date:</td>
                                                            <td></td>
                                                            <td>{{ $student->created_at }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">RTO Name:</td>
                                                            <td></td>
                                                            <td>{{ config('settings.site.institute_name', 'Key Institute') }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3">RTO Code:</td>
                                                            <td></td>
                                                            <td>{{ config('settings.site.institute_rto_code', 20855) }}</td>
                                                        </tr>
                                                        @isset($enrolments['basic'])
                                                            <tr>
                                                                <td colspan="3">Study Schedule:</td>
                                                                <td></td>
                                                                <td>{{ $enrolments['basic']['schedule'] }}</td>
                                                            </tr>
                                                        @endisset
                                                        ...
                                                        @foreach( $student->courseEnrolments as $registered)
                                                            @php $cid = intval($registered->course->id ?? 0); @endphp
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td></td>
                                                                <td>{{ $registered->course_start_at }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="3">End Date:</td>
                                                                <td></td>
                                                                <td>{{ $registered->course_ends_at }}</td>
                                                            </tr>
                                                            @endif
                                                        @endforeach
                                                    </table>
                                        ...
                                        <p style="margin: 24px 0;">
                                            <strong>Login</strong> to the Team Member Progress Portal below:</p>
                                        <p style="margin: 24px 0;">
                                            <a href="{{ env('APP_URL') }}"
                                               style="cursor: pointer;font-weight: 700;border-color: #ff9f43 !important;background-color: #ff9f43 !important;color: #FFFFFF !important;text-align: center;vertical-align: middle;padding: 0.786rem 1.5rem;font-size: 1rem;border-radius: 0.358rem;"
                                ...
                                <tr>
                                    <td style="padding-bottom: 32px; background-color: #FFFFFF;text-align: center">
