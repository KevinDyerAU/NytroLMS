    ...
    <div class="card-header flex-row align-items-start pb-0">
        <div class='col-2'>
            <div class="avatar bg-success p-50 m-0">
                <a href="{{ route('competencies.index') }}" class="avatar-content">
                    <i data-lucide="award" class="font-medium-5"></i>
                </a>
            </div>
        </div>
        <div class='col-8 d-flex flex-row align-items-center align-self-center'>
            <h3 class="card-text flex-wrap pe-1">Students Competency</h3>
...
<script>
    (function(window, document, $) {
        $(window).on('load', function() {
            ...
            let $chart = document.querySelector('#competency-chart');
            let chartOptions = {
                chart: {
                    height: 100,
                    width: '100%',
