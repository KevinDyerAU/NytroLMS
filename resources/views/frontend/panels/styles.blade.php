...
@if($configData['mainLayoutType'] === 'horizontal')
    <link rel="stylesheet"
          href="{!! asset(mix("css/{$settings_key}/base/core/menu/menu-types/horizontal-menu.css")) !!}"/>
@else
    <link rel="stylesheet"
          href="{!! asset(mix("css/{$settings_key}/base/core/menu/menu-types/vertical-menu.css")) !!}"/>
@endif
...
@if($configData['direction'] === 'rtl' && isset($configData['direction']))
    <link rel="stylesheet"
          href="{!! asset(mix("css-rtl/{$settings_key}/custom-rtl.css")) !!}"/>
    <link rel="stylesheet"
          href="{!! asset(mix("css-rtl/{$settings_key}/style-rtl.css")) !!}"/>

@else
    {{-- user custom styles --}}
    <link rel="stylesheet"
          href="{!! asset(mix("css/{$settings_key}/default.css")) !!}"/>
@endif
