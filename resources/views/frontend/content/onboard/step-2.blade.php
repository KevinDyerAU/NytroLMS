    ...
    <form method="POST" action="{{ route('frontend.onboard.store', ['step' => $step, 'resumed' => 1]) }}">
        ...
        <div class="row">
            ...
            <div class='col-lg-6 col-12'>
                <div class="content-header">
                    <div class="clearfix divider divider-secondary divider-start-center ">
                        <span class="divider-text text-dark">Qualifications:</span>
                    </div>
                </div>
                <div class="row">
                    <div class="mb-1 col-12">
                        <label class="form-label required" for="employment">
                        ...
                        <select data-placeholder="Select an Option..." tabindex="3" class="select2 form-select"
                            ...
                            <option></option>
                            <option value="no"
                                {{ old('additional_qualification') == 'no' ? 'selected="selected"' : (!empty($enrolment) && $enrolment['additional_qualification'] === 'no' ? 'selected="selected"' : '') }}>
                                No
                            </option>
                            <option value="yes"
                                {{ old('additional_qualification') == 'yes' ? 'selected="selected"' : (!empty($enrolment) && $enrolment['additional_qualification'] === 'yes' ? 'selected="selected"' : '') }}>
                                Yes
                            </option>
                        </select>
