...
(function (window, document, $) {
            ...
            if (value != '') {
                ...
                $.getJSON(
                    ...
                    function (data) {
                        ...
                        $('ul.search-list').html(DOMPurify.sanitize($htmlList));
                        // concatinating otherlist with startlist
                        $bookmarkhtmlList = $startList.concat($otherList);
                        $('ul.search-list-bookmark').html(
                            DOMPurify.sanitize($bookmarkhtmlList)
                        );
                        // Feather Icons
                        // if (feather) {
                        //   featherSVG();
    ...
    function getCurrentLayout() {
        ...
        // else if ($("meta[name='theme']").length > 0 && $("meta[name='theme']").data('session')) {
        //     console.log('meta session: ' +$("meta[name='theme']").data('session'));
        //     currentLayout = ($("meta[name='theme']").data('session')) + '-layout'
    ...
    var dataLayout = $html.attr('data-layout')
        ...
        : 'light-layout';
    // console.log('dataLayout: ' + dataLayout,localStorage);
    ...
    $('.nav-link-style').on('click', function () {
        ...
        // console.log('load currentLayout: ' +currentLayout, prevLayout);
        ...
        // console.log('existing local storage',localStorage);
        // Set Previous skin in local db
        localStorage.setItem(dataLayout + '-prev-skin', currentLayout);
        // Set Current skin in local db
        localStorage.setItem(dataLayout + '-current-skin', switchToLayout);
        // console.log('new local storage',localStorage, switchToLayout);
        // Call set layout
