(function ($, DataTable) {
    ...
    var _downloadFromUrl = function (url, params) {
        ...
        toastr.info('Please wait, downloading', {timeOut: 5000});
        ...
        xhr.onprogress = function(event){
            // toastr.clear();
            toastr.info('Downloading in progress');
        ...
        xhr.onload = function () {
            ...
            toastr.clear();
            toastr.success('File ready to save', 'Download Successful', {timeOut: 5000})
            if (this.status === 200) {
                ...
                if (typeof window.navigator.msSaveBlob !== 'undefined') {
                    ...
                    if (filename) {
                        ...
                        if (typeof a.download === 'undefined') {
                            ...
                            // console.log('download url redirected', downloadUrl);
                        } else {
                            a.href = downloadUrl;
                            a.download = filename;
                            document.body.appendChild(a);
                            a.click();
                            // console.log(filename, 'download url clicked', downloadUrl);
                        }
                    } else {
                        window.location = downloadUrl;
                        // console.log('redirect to download url', downloadUrl);
                    }
