...
class ArchivedCourseDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('', '')
            ->addColumn('', '')
            ->editColumn('course_category', function (
            ...
            ->rawColumns(['course_category', 'pre_course_assessment']);
    }
    ...
    {
        return 'LMS/ArchivedCourse_' . date('YmdHis');
    }
}
