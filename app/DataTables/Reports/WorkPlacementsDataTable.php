...
class WorkPlacementsDataTable extends DataTable
{
    ...
    public function fastExcelCallback(): \Closure
    {
        return function (WorkPlacement $model) {
            return [
                'ID' => $model->id,
                'Student ID' => $model->user ? $model->user->id : '',
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return datatables()
            ...
            ->filterColumn('consultation_completed_on', function (
                $query,
                $keyword
            ) {
            ...
            ->addColumn('action', 'reports/work_placement.action');
    }
    ...
    {
        return $this->builder()
            ->setTableId('work-placement-report-table')
    ...
    {
        return 'WorkPlacements_' . date('YmdHis');
    }
}
