...
@section('content')
    <section id="leaders-datatable">
        {{ $dataTable->table() }}
        <!-- Modal to add new record -->
        @if ($hasModal ?? false)
            <div class="modal modal-slide-in fade" id="modals-slide-in">
                <div class="modal-dialog sidebar-sm">
                    <form method='POST' action='{{ route('account_manager.leaders.store') }}'
    ...
    <script>
        $(function() {
            ...
            defaults.columnDefs = myDataTable.setupActionColumnDef(defaults, {
                view: '{{ route('account_manager.leaders.show', ':id') }}',
                edit: '{{ route('account_manager.leaders.edit', ':id') }}',
            }, true);
