    ...
    <script>
        ...
        $(function() {
            ...
            @endcan
                ...
                view: '{{ route('lms.'.\Str::plural($post['type']).'.show',':id') }}',
                edit: '{{ route('lms.'.\Str::plural($post['type']).'.edit',':id') }}',
                @if($post['type'] !== 'course')
                destroy: "LMS.destroy(event, '{{ \Str::plural($post['type']) }}', :id )",
                @endif
            }, true);
