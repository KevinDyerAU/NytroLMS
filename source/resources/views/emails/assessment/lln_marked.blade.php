...
<div style="display: none;">Your Language, Literacy, Numeracy and Digital (LLND) Activity Result:</div>
<div role="article" aria-roledescription="email" aria-label="Language, Literacy, Numeracy and Digital (LLND) Activity" lang="en">
    <table style="font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; width: 100%;" width="100%"
        ...
        <tr>
            <td align="center"
                ...
                <table class="sm-w-full" style="font-family: 'Montserrat',Arial,sans-serif; width: 90%;" width="90%"
                       cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td class="sm-py-32 sm-px-24"
                            ...
                            align="center">
                            <a href="{{ env('APP_URL') }}">
                                <img src="{{ config('settings.site.site_logo', asset('images/logo/logo.png')) }}" width="155" alt="{{ env('APP_NAME') }}"
                                    ...
                                    <td class="sm-px-24"
                                        ...
                                        @if( $status !== "SATISFACTORY")
                                            <p style='line-height: 1.5rem;'>
                                                Unfortunately,  you have achieved not satisfactory result in "{{ $lesson ?? "" }}". Please contact us for further information about your course.
                                            </p>
                                            <p style='line-height: 1.5rem;'>
                                                Feedback: {!! $attempt->quiz->feedbacks()->orderBy('id','DESC')->first()?->body['message']  !!}
                                            </p>
                                        @elseif( $status === "SATISFACTORY" && $assisted)
                                            <p style='line-height: 1.5rem;'>
                                                You have achieved satisfactory result with support in "{{ $lesson ?? "" }}".
                                                Please commence your course and let us know if you need any assistance with the course. We are here to help.
                                                <br />
                                                Here is the feedback in this unit: <i>{!! $attempt->quiz->feedbacks()->orderBy('id','DESC')->first()?->body['message']  !!}</i>
                                            </p>
                                        @else
                                            <p style='line-height: 1.5rem;'>
                                                Congratulations on achieving satisfactory result in "{{ $lesson ?? "" }}" and you can commence the course now.
                                            </p>
                                        @endif
                                        ...
                                        <p style="margin: 0 0 16px;">{{ config('settings.site.institute_phone', '1300 471 660') }}</p>
                                    </td>
                                </tr>
                                <tr>
