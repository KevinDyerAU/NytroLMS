...
<body
    ...
    <div style="display: none;">Student Registration Receipt</div>
    <div role="article" aria-roledescription="email" aria-label="Student Registration Receipt" lang="en">
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <h2 style="font-weight: 600; font-size: 20px; margin-bottom: 20px;">
                                                Student Registration Receipt</h2>

                                            <p style="margin: 0 0 24px;">
                                                Thank you for registering a student. This is a confirmation receipt for
                                                the registration submitted on {{ now()->format('dd/mm/yyyy hh:mm A') }}.
                                            </p>

                                            <p
                                                style="margin: 0 0 24px; background-color: #fff3e0; padding: 12px; border-left: 4px solid #ff9800; border-radius: 4px;">
                                                <strong>Note:</strong> This student's email was previously registered
                                                with us. Our administration team will need to review this account, You
                                                will be notified once this review is complete.
                                            </p>
                                            ...
                                            <div
                                                ...
                                                <p style="margin: 8px 0;"><strong>Email Address:</strong>
                                                    {{ $originalEmail }}</p>
