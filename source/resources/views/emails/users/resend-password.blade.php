...
<head>
    ...
    <![endif]-->
    <title>Your {{ env('APP_NAME') }} Password</title>
    <link
...
<body
    ...
    <div style="display: none;">Your {{ env('APP_NAME') }} Password</div>
    <div role="article" aria-roledescription="email" aria-label="Password" lang="en">
                                ...
                                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%"
                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                style="font-weight: 700; font-size: 20px; margin-top: 0;">
                                                <span style="color:#000000;">Hi
                                                </span>{{ \Str::title($notifiable->name) }},
                                            </p>
                                            <p
                                                style="font-weight: 700; font-size: 20px; margin-top: 0; --text-opacity: 1;">
                                                <strong>Your new {{ env('APP_NAME') }} Password</strong>
                                            </p>
                                            <p style="margin: 0 0 24px;">
                                                A Key Institute Administrator has reset your password for your {{ env('APP_NAME') }} account.
                                            </p>
                                            <p style="margin: 0 0 24px;">To access your account, please use the following login details:</p>
                                            <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0"
                                                cellspacing="0" role="presentation">
                                                <tr>
                                                    <td>Username: </td>
                                                    <td>&nbsp;</td>
                                                    <td><strong>{{ $notifiable->username }}</strong></td>
                                                </tr>
                                                <tr>
                                                    <td>Password: </td>
                                                    <td>&nbsp;</td>
                                            ...
                                            <p style="margin: 24px 0;">
                                                <strong>Note:</strong> Please keep your password secure. You can change your password at any time from your profile settings.
                                            </p>

                                            <p style="margin: 0 0 16px;">Thanks, <br>Key Institute Admin Team</p>
                                            ...
                                            <p>Please note this is an automated email, please do not reply directly to this email </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
