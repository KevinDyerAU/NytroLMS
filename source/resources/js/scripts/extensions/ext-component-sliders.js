...
$(function () {
    ...
    var defaultColorSlider = document.getElementById('default-color-slider'),
        secondaryColorSlider = document.getElementById(
    ...
    if (
        typeof defaultColorSlider !== undefined &&
        defaultColorSlider !== null
    ) {
    ...
    if (
        typeof successColorSlider !== undefined &&
        successColorSlider !== null
    ) {
    ...
    if (
        typeof warningColorSlider !== undefined &&
        warningColorSlider !== null
    ) {
    ...
    // Connect to upper
    if (
        typeof connectUpperSlider !== undefined &&
        connectUpperSlider !== null
    ) {
